...
const Hero = () => {
  return (
    <section
      className='bg-cover hero-bg bg-center relative'
      style={{
        height: '618.2px',
    ...
    >
      <div className='container py-28 z-50 relative text-white'>
        <h1 className='text-primaryColor text-2xl '>WELCOME TO</h1>
        ...
        <div className='my-14 max-w-[656.89px] leading-[36px] '>
          ...
          <button className='mt-12 rounded-md font-bold bg-primaryColor p-2.5  max-w-[193px] w-full'>
            CONTACT US
          </button>
        </div>
      </div>
