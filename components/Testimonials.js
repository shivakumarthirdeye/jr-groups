...
const testimonials = [
  ...
  {
    id: 2,
    review: `JR Group maintains on-site fire alarm systems and extinguishers. The assistance and continued assistance we have received cannot be faulted, and their Service Engineer's commitment and efficiency were flawless.`,
    name: 'Jhon David',
    role: 'Manager at XYZ',
    img: profile,
  },
  {
    id: 3,
    review: `We have been very impressed with the speed with which JR Group has responded to any issues we have encountered during our working relationship. Whether it's a damaged extinguisher or a misplaced test key, they'll often be with us on the same day to meet our needs.`,
    name: 'Jhon David',
    role: 'Manager at XYZ',
    img: profile,
  },
...
const Testimonials = () => {
  return (
    <section className='bg-[#1f375f19] my-0 pb-0 lg:pb-20 py-20 '>
      <div className='relative '>
        ...
        <ContactInfo className='left-[50%] translate-x-[-50%]  absolute bottom-[-150px]' />
      </div>
    </section>
  );
};
